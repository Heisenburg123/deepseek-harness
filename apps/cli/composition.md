...
flowchart LR
  ...
  plugin_dsh_base_final_response_presentation["final-response-presentation<br/>@deepseek-ai/dsh-final-response-presentation"]
  cfg --> plugin_dsh_base_final_response_presentation
...
| `final-response-presentation` | `@deepseek-ai/dsh-final-response-presentation` |
