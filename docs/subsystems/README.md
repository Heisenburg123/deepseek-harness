...
| [final-response-presentation.md](final-response-presentation.md) | process-local post-completion display transformation, Agent-scoped selection, neutral decisions, and transient transport annotations |
