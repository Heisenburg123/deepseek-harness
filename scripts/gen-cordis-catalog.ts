...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  finalResponsePresentation: 'final-response-presentation.md',
  fs: 'filesystem.md',
  goals: 'goal.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  FinalResponseDecision: 'final-response-presentation.md',
  ...
  PresentationController: 'final-response-presentation.md',
  PresentationSelection: 'final-response-presentation.md',
  PresentationState: 'final-response-presentation.md',
  ...
  ResponsePresentationAnnotation: 'final-response-presentation.md',
